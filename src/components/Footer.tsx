      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold text-white tracking-tight">PandinGroups</span>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed mb-4">
              Where luxury meets comfort. Experience world-class hospitality at PandinGroups — your home away from home.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-slate-400">14 Victoria Island Boulevard, Lagos, Nigeria</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+2341234567890" className="text-sm text-slate-400 hover:text-sky-400 transition-colors">+234 (0) 123 456 7890</a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-4 h-4 text-sky-500 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@pandingroups.com" className="text-sm text-slate-400 hover:text-sky-400 transition-colors">info@pandingroups.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500">
            © {new Date().getFullYear()} PandinGroups. All rights reserved.
          </p>
          <p className="text-sm text-slate-500">
