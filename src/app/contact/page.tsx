            ...
            <div className="lg:col-span-2">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 bg-[#C41230] text-white font-semibold rounded-xl hover:bg-[#921224] transition-colors shadow-md"
                  >
                    Send Enquiry
                  </button>
                  <p className="text-xs text-slate-400 text-center">We respond within 2 hours during business hours (8 AM Ã¢â‚¬â€œ 10 PM)</p>
                </form>
              )}
            </div>
          </div>
